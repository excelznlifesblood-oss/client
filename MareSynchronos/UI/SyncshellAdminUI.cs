        ...
        if (tabbar)
        {
            ...
            if (mgmtTab)
            {
                ...
                if (clearNode)
                {
                    ...
                    UiSharedService.AttachToolTip($"This will start the prune process for this Syncshell of inactive Shonin Sync users that have not logged in in the past {_pruneDays} days."
