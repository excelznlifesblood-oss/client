...
internal sealed partial class CharaDataHubUi : WindowMediatorSubscriberBase
{
    ...
    {
        _uiSharedService.BigText("Shonin Sync Character Data File Export");

        DrawHelpFoldout("This feature allows you to pack your character into a MCDF file and manually send it to other people. MCDF files can officially only be imported during GPose through Shonin Sync. " +
